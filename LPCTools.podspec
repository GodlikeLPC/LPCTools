...
Pod::Spec.new do |s|
  ...
  李沛池工具汇总、5年iOS架构经验总结出的一套用于快速搭建新启动App的框架、持续完善、普惠天下
                       DESC
  s.homepage         = 'https://github.com/godlikelpc@gmail.com/LPCTools'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'godlikelpc@gmail.com' => 'lipeichi@jd.com' }
  s.source           = { :git => 'https://github.com/godlikelpc@gmail.com/LPCTools.git', :tag => s.version.to_s }
